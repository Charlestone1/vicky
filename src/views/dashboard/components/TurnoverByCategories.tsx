...
type TurnoverByCategoriesProps = {
    data?: {
        labels: string[]
        data: number[]
    }
...
const TurnoverByCategories = ({
    data = { labels: ['Suv', 'Sedan', 'Truck'], data: [160, 122, 90] },
}: TurnoverByCategoriesProps) => {
    return (
        <Card>
...
export default TurnoverByCategories
