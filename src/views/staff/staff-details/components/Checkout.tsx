...
const CheckOut = (props: CheckinFormProps) => {
    ...
    const chechOutThisSTaff = async (
        ...
        if (result?.status === 'failed') {
            ...
            toast.push(
                <Notification title={`Successfully Checked Out`} type="success">
                    Successfully Checked Out the Staff.
                </Notification>
            )
        }
        setSubmitting(false)
    ...
    return (
        <div className='flex flex-col'>
            <h6 className='text-gray-500'>Are you sure you want to Check-Out this Staff?</h6>
            {success ? null : (
                <>
                    {message && (
                        <Alert
            ...
            <Formik
                ...
                onSubmit={(values, { setSubmitting }) => {
                    if (props.disableSubmit) {
                        chechOutThisSTaff(values, setSubmitting)
                    } else {
                        setSubmitting(false)
                    }
                }}
