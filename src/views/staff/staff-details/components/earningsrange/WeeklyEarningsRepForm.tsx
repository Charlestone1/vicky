...
import { apiEarningsRepWeekly } from '@/store/slices/earnings-report/earningsReportSlice'
...
const WeeklyEarningsRepForm = (props: CheckinreportProps) => {
    ...
    const checkWeeklyEarningsReport = async (
        ...
        try {
            await dispatch(apiEarningsRepWeekly({ staffId, date }))
        ...
        <div className='h-10'>
            <Formik
                ...
                onSubmit={(values, { setSubmitting }) => {
                    if (!disableSubmit) {
                        checkWeeklyEarningsReport(values)
                    } else {
                        setSubmitting(false)
                    }
                }}
...
export default WeeklyEarningsRepForm
