...
interface EditWindshieldInstallFormProps extends CommonProps {
    data: {
        id: string
        name: string
...
type EditWindshieldInstallFormSchema = {
    customerTime: number
    timeOfCompletion: number
    filmQualityOrVehicleCategoryAmount: {
        filmQualityId: string
...
const EditWindshieldInstall = (props: EditWindshieldInstallFormProps) => {
    ...
    const editSingleTintService = async (
        values: EditWindshieldInstallFormSchema,
                                    ...
                                    >
                                        <Field name="timeOfCompletion">
                                            {({
                                                field,
                                                form,
                                            }: FieldProps<EditWindshieldInstallFormSchema>) => (
                                                <Select
                                                    field={field}
                                                    form={form}
...
export default EditWindshieldInstall