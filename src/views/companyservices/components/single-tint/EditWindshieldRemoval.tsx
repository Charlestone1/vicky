...
export const EditWindshieldRemoval = (props: EditSingleTintRFormProps) => {
    ...
    const editSingleTintRemService = async (
        values: EditWindshieldFormSchema,
                                    ...
                                    >
                                        <Field name="timeOfCompletion">
                                            {({
                                                field,
                                                form,
                                            }: FieldProps<EditWindshieldFormSchema>) => (
                                                <Select
                                                    field={field}
                                                    form={form}
