...
import EditSingleTintInstall from './EditSingleTintInstall'
import AddSingleTint from './AddSingleTint'
    ...
    return (
        <div className="flex justify-between gap-x-2 my-4">
            ...
            <div>
                ...
                >
                    <h5 className="mb-4">Create Single Tint Installation Service</h5>
                    <AddSingleTint setIsOpen={setIsOpen} />
                </Dialog>
            </div>
        </div>
    )
...
const SingleTintInstal = () => {
    ...
    const actionButtonsColumn = {
        ...
        cell: ({ row }: { row: Row<Service> }) => {
            ...
            //     console.log(`Edit Services ${updateData}`)
            //     console.log(updateData);

            // }

            // const handleServiceDelete = () => {
            //     console.log(`Delete Services ${row.original.name}`)
            // }
    ...
    if (singleTint.length === 0) {
        return (
            <Card className="flex justify-center flex-col items-center min-h-[25rem]">
                <p className="text-center">No Single Tint Installation Services have been added</p>
        ...
        <div className="border border-gray-300 rounded-lg p-3">
            ...
            <div>
                <Table>
                    ...
                    >
                        <h5 className="mb-4">Update Single Tint Service Details</h5>
                        <EditSingleTintInstall
                            disableSubmit
                            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                            data={updateData!}
                    ...
                    >
                        <h5 className="mb-4">Delete Single Tint Installation Service</h5>
                        <DeleteService
                            disableSubmit
                            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                            data={oneDelete!}
...
export default SingleTintInstal