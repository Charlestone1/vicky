...
import AddSingleRemoval from './AddSingleRemoval'
import EditSingleTintRemoval from './EditSingleTintRemoval'
    ...
    return (
        <div className="flex justify-between gap-x-2 my-4">
            ...
            <div>
                ...
                >
                    <h5 className="mb-4">Create Single Tint Service</h5>
                    <AddSingleRemoval setIsOpen={setIsOpen} />
                </Dialog>
            </div>
        </div>
    )
...
const SingleTintRemoval = () => {
    ...
    if (singleTint.length === 0) {
        return (
            <Card className="flex justify-center flex-col items-center min-h-[25rem]">
                <p className="text-center">No Single Tint Removal Services have been added</p>
                <div className="text-center mt-4">
                    ...
                    <Dialog
                        ...
                        onRequestClose={onDialogClose}
                    >
                        <h5 className="mb-4">Create Single Tint Removal Service</h5>
                        <AddSingleRemoval setIsOpen={setIsOpen} />
                    </Dialog>
                </div>
            </Card>
        ...
        <div className="border border-gray-300 rounded-lg p-3">
            ...
            <div>
                <Table>
                    ...
                    >
                        <h5 className="mb-4">Delete Single Tint Removal Service</h5>
                        <DeleteService
                            disableSubmit
                            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                            data={oneDelete!}
...
export default SingleTintRemoval