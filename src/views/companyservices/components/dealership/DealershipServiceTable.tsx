...
import AddDealershipService from './AddDealershipService'
import EditDealershipService from './EditDealershipService'
    ...
    return (
        <div className="flex justify-between gap-x-2 my-4">
            ...
            <div>
                ...
                >
                    <h5 className="mb-4">Create Dealership  Service</h5>
                    <AddDealershipService setIsOpen={setIsOpen} />
                </Dialog>
            </div>
        </div>
    )
...
const DealershipServiceTable = () => {
        ...
        try {
            if (data) {
                const filteredService = data.filter(service =>
                    service.type === "dealership" && service.isForDealership === true
                );
    ...
    if (fullTint.length === 0) {
        return (
            <Card className="flex justify-center flex-col items-center min-h-[25rem]">
                <p className="text-center">No Dealership Services have been added.</p>
        ...
        <div className="border border-gray-300 rounded-lg p-3">
            ...
            <div>
                <Table>
                    ...
                    >
                        <h5 className="mb-4">Update Dealership Service Details</h5>

                        <EditDealershipService
                            disableSubmit
                            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                            data={updateData!}
                    ...
                    >
                        <h5 className="mb-4">Delete Dealership Service</h5>
                        <DeleteService
                            disableSubmit
                            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                            data={oneDelete!}
...
export default DealershipServiceTable