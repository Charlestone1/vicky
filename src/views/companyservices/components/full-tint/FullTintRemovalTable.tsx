...
import AddFullTintRemoval from './AddFullTintRemoval'
import EditFullTintRemoval from './EditFullRemoval'
    ...
    return (
        <div className="flex justify-between gap-x-2 my-4">
            ...
            <div>
                ...
                >
                    <h5 className="mb-4">Create Full Tint Removal Service</h5>
                    <AddFullTintRemoval setIsOpen={setIsOpen} />
                </Dialog>
            </div>
        </div>
    )
...
const FullTintRemovalTable = () => {
        ...
        try {
            if (data) {
                const filteredService = data.filter(service =>
                    service.type === "removal" && service.isFull === true
                );
    ...
    if (fullTint.length === 0) {
        return (
            <Card className="flex justify-center flex-col items-center min-h-[25rem]">
                <p className="text-center">No Full Tint Removal Services have been added</p>
        ...
        <div className="border border-gray-300 rounded-lg p-3">
            ...
            <div>
                <Table>
                    ...
                    >
                        <h5 className="mb-4">Update Full Tint Removal Service Details</h5>
                    ...
                    >
                        <h5 className="mb-4">Delete Full Tint Removal Service</h5>
                        <DeleteService
                            disableSubmit
                            // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                            data={oneDelete!}
...
export default FullTintRemovalTable